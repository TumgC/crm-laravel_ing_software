...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="rounded-2xl p-6 text-white shadow-lg bg-gradient-to-br from-blue-500 to-indigo-700">
            <div class="flex items-start justify-between">
                ...
                <span class="text-xs bg-white/20 px-2 py-1 rounded-full">+{{ $ticketsTotal }}</span>
            </div>
            <div class="mt-3 text-3xl font-extrabold">{{ $ticketsTotal }}</div>
        ...
        <div class="rounded-2xl p-6 text-white shadow-lg bg-gradient-to-br from-purple-500 to-fuchsia-700">
            ...
            <div class="mt-3 text-3xl font-extrabold">{{ $ticketsAbiertos }}</div>
        ...
        <div class="rounded-2xl p-6 text-white shadow-lg bg-gradient-to-br from-emerald-500 to-green-700">
            ...
            <div class="mt-3 text-3xl font-extrabold">{{ $ticketsAsignados }}</div>
        ...
        <div class="rounded-2xl p-6 text-white shadow-lg bg-gradient-to-br from-orange-500 to-red-600">
            ...
            <div class="mt-3 text-3xl font-extrabold">{{ $opTotal }}</div>
            <div class="mt-1 text-xs opacity-80">En el embudo</div>
        </div>

    </div>

    {{-- Segunda fila: gráfico (placeholder) + rendimiento --}}
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div class="space-y-3 text-sm">
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold">{{ $opProspecto }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-slate-600">Negociación</span>
                    <span class="font-semibold">{{ $opNegociacion }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-slate-600">Cerrado Ganado</span>
                    <span class="font-semibold">{{ $opCerradoGanado }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-slate-600">Cerrado Perdido</span>
                    <span class="font-semibold">{{ $opCerradoPerdido }}</span>
                </div>
            </div>
    ...
    {{-- Actividad reciente (por ahora placeholder) --}}
    <div class="bg-white rounded-2xl shadow-sm p-6">
